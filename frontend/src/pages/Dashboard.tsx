    ...
    <div className="relative min-h-full">
      ...
      {profile && (
        <DashboardLayout onCreateEpisode={handleCreateEpisode}>
          <div className="mb-8 rounded-[var(--radius-lg)] border border-[var(--color-border)] bg-[var(--color-surface)] p-6 shadow-sm">
            <div className="flex items-center">
              <div className="w-10 h-10 rounded-[var(--radius-md)] bg-[var(--color-accent-subtle)] text-[var(--color-accent)] flex items-center justify-center mr-3">

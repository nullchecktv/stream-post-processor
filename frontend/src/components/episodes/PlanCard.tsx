...
function PlanCardComponent({
  ...
  return (
    <div
      className="bg-[var(--color-surface)] rounded-[var(--radius-lg)] border border-[var(--color-border)] border-l-4 border-l-[var(--color-accent)] hover:bg-[var(--color-surface-hover)] hover:border-[var(--color-border)] transition-colors duration-[var(--duration-fast)] cursor-pointer h-[140px] flex relative group overflow-hidden"
    ...
    >
      ...
      <div className="w-6 border-l border-[var(--color-divider)] flex items-center justify-center bg-[var(--color-surface-raised)] group-hover:bg-[var(--color-surface-hover)] transition-colors duration-[var(--duration-fast)]">
        <svg className="w-4 h-4 text-[var(--color-accent)] transition-colors duration-[var(--duration-fast)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">

...
interface EpisodeStatusChipProps {
  status: 'Draft' | 'Planning' | 'Ready' | 'Processing' | 'Published' | 'Archived' | string
  size?: 'sm' | 'md' | 'lg'
  showIcon?: boolean
  showHelp?: boolean
}
...
const statusDescriptions: Record<string, string> = {
  ...
  Planning: 'Episode plan has been added',
  Ready: 'Upload complete, ready to detect clips with AI',

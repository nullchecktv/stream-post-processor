      ...
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <p className="text-sm font-medium text-gray-700">No video tracks uploaded yet</p>
            <p className="text-xs text-gray-500 mt-1">Upload video tracks to begin processing</p>
          </div>
        </div>
      </div>
    )
    ...
    return (
      <div className="bg-green-50 border border-green-200 rounded-lg p-4">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <p className="text-sm font-medium text-green-800">Single track - speaker attribution optional</p>
    ...
    return (
      <div className="bg-green-50 border border-green-200 rounded-lg p-4">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <p className="text-sm font-medium text-green-800">{trackCount} tracks with speaker attribution</p>
            <p className="text-xs text-green-700 mt-1">
